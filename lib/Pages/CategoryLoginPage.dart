...
import 'categoryloginpage_model.dart';
export 'categoryloginpage_model.dart';

class CategoryLoginPageWidget extends StatefulWidget {
  const CategoryLoginPageWidget({super.key});

  static String routeName = 'CategoryLoginPage';
  static String routePath = '/category-login';

  @override
  State<CategoryLoginPageWidget> createState() =>
      _CategoryLoginPageWidgetState();
}

class _CategoryLoginPageWidgetState extends State<CategoryLoginPageWidget> {
  late CategoryLoginPageModel _model;
  ...
  // Handle login based on category
  Future<void> _handleLogin(String category) async {
    ...
    try {
      ...
      print('Login successful, redirecting to: $redirectPath');
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Select your category and login to continue',
                ...
                if (_model.selectedCategory != null) ...[
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Login as ${_model.selectedCategory!.toUpperCase()}',
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            await _handleLogin(_model.selectedCategory!);
                          },
                          text: 'Login',
